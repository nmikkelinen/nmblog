...
.cv-section h2 {
    border-bottom: 1px solid #2e354f;
    padding-bottom: 6px;
    margin-bottom: 15px;
...
@media print {
    ...
    header, footer, hr, .cv-selectors, script, button, div[style*="margin-bottom"] {
    ...
    .job-company, .edu-school, .cv-title p, .skill-category strong {
...
<div class="cv-container">
    ...
    <!-- HEADER SECTION -->
    <div class="cv-header">
        <img src="/assets/images/profile.png" alt="Nicklas Mikkelinen" class="cv-photo">
        <div class="cv-title">
    ...
    <div class="cv-section">
        ...
        <div class="skill-category">
            <strong>Security & Risk Management:</strong> Information Security, Protective Security (Säkerhetsskydd), Risk Management
        </div>
        <div class="skill-category">
            <strong>Frameworks & Compliance:</strong> GRC, NIS2/CSL, ISO 27001, NIST, GDPR, DORA
        </div>
        <div class="skill-category">
            <strong>Infrastructure:</strong> IT/OT Security, Infrastructure Resilience, Industrial Cybersecurity
        </div>
        <div class="skill-category">
            <strong>Leadership & Governance:</strong> Executive Reporting, Steering Committees, Change Management, Security Strategy, Crisis Management, Authority Collaboration
        </div>
    </div>
        ...
        <div class="job-block">
            <div class="job-header">
                <div>
                    ...
                    <div class="job-company">Gestamp Hardtech AB</div>
                </div>
        ...
        <div class="job-block">
            <div class="job-header">
                <div>
                    ...
                    <div class="job-company">Swedbank AB</div>
                </div>
        ...
        <div class="job-block">
            <div class="job-header">
                <div>
                    ...
                    <div class="job-company">Luleå Municipality</div>
                </div>
        ...
        <div class="job-block">
            <div class="job-header">
                <div>
                    ...
                    <div class="job-company">Facebook (Meta)</div>
                </div>
        ...
        <div class="job-block">
            <div class="job-header">
                <div>
                    ...
                    <div class="job-company">Milestone Technologies, Inc.</div>
                </div>
        ...
        <div class="job-block">
            <div class="job-header">
                <div>
                    ...
                    <div class="job-company">The University of Skövde</div>
                </div>
        ...
        <div class="job-block">
            <div class="job-header">
                <div>
                    ...
                    <div class="job-company">Fanboys AB</div>
                </div>
        ...
        <div class="job-block">
            <div class="job-header">
                <div>
                    ...
                    <div class="job-company">Teleperformance Nordic</div>
                </div>
        ...
        <div class="edu-block">
            <div class="edu-header">
                <div>
                    ...
                    <div class="edu-school">Luleå University of Technology</div>
                </div>
        ...
        <div class="edu-block">
            <div class="edu-header">
                <div>
                    ...
                    <div class="edu-school">University of Skövde</div>
                </div>
    ...
    <!-- CERTIFICATES -->
    <div class="cv-section">
        <h2>Certificates and Prizes</h2>
        <ul style="list-style-type: none; padding-left: 0;">
            <li style="margin-bottom: 5px;"><strong>2012</strong> | IT Essentials: PC Hardware and Software</li>
            <li style="margin-bottom: 5px;"><strong>2013</strong> | CCNA Exploration: Routing Protocols and Concepts</li>
            <li style="margin-bottom: 5px;"><strong>2013</strong> | CCNA Exploration: Network Fundamentals</li>
            <li style="margin-bottom: 5px;"><strong>2013</strong> | CCNA Exploration: LAN Switching and Wireless</li>
            <li style="margin-bottom: 5px;"><strong>2013</strong> | CCNA Exploration: Acessing the WAN</li>
        </ul>
    </div>
